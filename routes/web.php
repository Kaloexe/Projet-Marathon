...
Route::get('/commentaire/delete/{id}',[CommentaireController::class, 'delete'])->name('commentaire.delete');

//Route::get('listeJeux/{nb?}',[JeuController::class, 'list'])->name('listeJeux');
